...
from PyQt5.QtGui import QPixmap, QImage, QPainter,QStandardItemModel
from PyQt5.QtCore import Qt
import fitz  # PyMuPDF
from PyQt5.QtPrintSupport import QPrintDialog

class PdfViewer(QMainWindow):
    def __init__(self, default_file_path="E:\机械设计诺顿资料\mechanical-design-program-4-master\数据文件\圈数和疲劳.pdf"):
        super().__init__()
...
if __name__ == '__main__':
    ...
    default_file_path = "..\数据文件\output_with_page_number.pdf"
