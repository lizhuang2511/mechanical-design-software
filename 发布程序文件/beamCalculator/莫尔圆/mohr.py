...
class Gui33:
    def __init__(self, app,弯曲应力,剪应力):
        self.r_plot = 0
    ...
    def build_canvas(self):
        ...
        try:
            with open("log.txt", 'w') as data:
                text = []
                text.append('tetap角度 = '+str(self.calc.tetap)+'\n')
                text.append('tetas = '+str(self.calc.tetas)+'\n')
                text.append('smax第一主应力 = '+str(self.calc.smax)+'\n')
                text.append('smin第二主应力= '+str(self.calc.smin)+'\n')
                text.append('tmax最大剪应力 = '+str(self.calc.tmax)+'\n')
                text.append('smed圆心坐标 = '+str(self.calc.save)+'\n')
                text.append('r 半径= '+str(self.calc.r)+'\n')
                text.append('nsx输入 = '+str(self.calc.nsx)+'\n')
                text.append('nsy输入 = '+str(self.calc.nsy)+'\n')
                text.append('ntxy输入 = '+str(self.calc.ntxy)+'\n')
