...
if __name__ == '__main__':
  print('开始打包')
  源码路径=r'E:\机械设计软件\mechanical-design-program-4-master'
  发布路径 = r'E:\机械设计软件\开源程序\发布程序文件'  # 替换为你要删除的目录的路径
  delete_directory(发布路径)
  minify_python_files(源码路径,发布路径)
  源码路径=r'E:\机械设计软件\第一次运行环境安装'
  发布路径 = r'E:\机械设计软件\开源程序\第一次运行环境安装'  # 替换为你要删除的目录的路径
  delete_directory(发布路径)
  minify_python_files(源码路径,发布路径)
  源码路径=r'E:\机械设计软件\辅组移动'
  发布路径 = r'E:\机械设计软件\开源程序'  # 替换为你要删除的目录的路径
  delete_directory(发布路径)
  minify_python_files(源码路径,发布路径)
  #pdf处理(r'E:\开放程序\数据文件')
  #执行转码(发布路径)
