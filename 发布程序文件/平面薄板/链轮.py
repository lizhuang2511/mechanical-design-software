...
print(type(sprocket_model))
# display the sprocket
from OCC.Core.STEPControl import  STEPControl_Writer
rt=STEPControl_Writer()
from OCC.Core.STEPControl import STEPControl_Writer, STEPControl_AsIs
rt.Transfer(sprocket_model,STEPControl_AsIs)
sa=rt.Write('lianlun.step')
from OCC.Core.STEPControl import STEPControl_Reader
from OCC.Core.AIS import AIS_InteractiveContext, AIS_Shape
#from OCC.Core.Graphic3d import Graphic3d_NOM_AMBIENT, Graphic3d_NOM_DIFFUSE
