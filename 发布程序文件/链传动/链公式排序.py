...
if __name__ == '__main__':
  ...
  wb = app.books.open(r'D:\MITCalcSW_64\mitcalc2\chains\公式储存.xlsx')
  sheet = wb.sheets['和并表']
  ...
  压入表=结果[1]
  公式表=结果[0]
  压入表.to_excel(r'D:\MITCalcSW_64\mitcalc2\chains\写入python压入表.xlsx')
  公式表.to_excel(r'D:\MITCalcSW_64\mitcalc2\chains\写入python公式表.xlsx')
  app.quit()
  app.kill()