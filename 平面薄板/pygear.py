...
from OCC.Core.Geom2d import Geom2d_Circle, Geom2d_Line, Geom2d_CartesianPoint, Geom2d_OffsetCurve, \
                       Geom2d_BSplineCurve, Geom2d_Curve, Geom2d_BSplineCurve
from OCC.Core.Geom import Geom_Plane, Geom_Circle, Geom_Line, Geom_BSplineCurve, Geom_OffsetCurve
from OCC.Core.Geom2dAPI import Geom2dAPI_PointsToBSpline, Geom2dAPI_InterCurveCurve, Geom2dAPI_ProjectPointOnCurve
from OCC.Core.GeomAPI import GeomAPI_PointsToBSpline, GeomAPI_ProjectPointOnCurve
from OCC.Core.gp import gp_Pnt, gp_Pnt2d, gp_Dir, gp_Dir2d, gp_Ax2, gp_Ax22d, gp_Circ,   \
...
from OCC.Core.BRepBuilderAPI import BRepBuilderAPI_MakeVertex,BRepBuilderAPI_MakeEdge,BRepBuilderAPI_Transform,BRepBuilderAPI_MakeFace,BRepBuilderAPI_MakeWire
from OCC.Core.TopoDS import TopoDS_Wire
from OCC.Core.TopoDS import topods as TopoDS_Cast
from OCC.Core.Geom2dGcc import Geom2dGcc_QualifiedCurve
from OCC.Core.Geom2dAdaptor import Geom2dAdaptor_Curve
from OCC.Core.Geom2d import Geom2d_Circle, Geom2d_Line, Geom2d_CartesianPoint, Geom2d_OffsetCurve,Geom2d_BSplineCurve, Geom2d_Curve, Handle_Geom2d_BSplineCurve_Create
from OCC.Core.GccEnt import *
from OCC.Core.Geom2dGcc import Geom2dGcc_Circ2d2TanRad
...
from numpy import zeros,nonzero,count_nonzero
...
class GearWheel:
    ...
    def _make3dGeomFrom2dGeom(self, geom2d_object, z_coord_of_plane=0.0):
        ...
        # convert offset curve
            ...
            basis_bspline2d  = geom2dconvert_CurveToBSplineCurve(basis_curve2d, Convert_TgtThetaOver2)
...
class CylindricalGearWheel(GearWheel):
    ...
    def _makeFormWire(self):
        ...
        for condition in [root_circle_condition, root_rounding_condition, involute_condition,  \
            ...
            if count_nonzero(condition)>1:
                ...
                edge = BRepBuilderAPI_MakeEdge(self._make3dGeomFrom2dGeom(curve.Curve()), \
    ...
    def makeCrossSection(self):
        ...
        if abs(self.data.get('d_s'))>tol:
             ...
             shaft_edge  = BRepBuilderAPI_MakeEdge(shaft_curve)
...
class ToothedRackTool(Tool):
    ...
    def _getParameterLimit(self, point=None):
        """
...
class GearHobber(Machine):
    ...
    def _checkEnvelope(self, point, no_supp_pnts=None):
        ...
        distance = list(map(self._PointInteriorMeasure, phi, [point]*no_supp_pnts))
        ...
        derivatives = list(map(distance_spline, phi, [1]*no_supp_pnts))
    ...
    def createToothShape(self, number_of_points=None):
        ...
        if number_of_points:
             ...
             if not list(map(type,number_of_points))==list(map(type,[1.0]*len(number_of_points))):
