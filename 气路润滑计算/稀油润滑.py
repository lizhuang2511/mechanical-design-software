...
水平导轨油量=多项式(1.263e-8,-2.122e-5,0.03749,-2.002,导轨长度)/2.4
垂直导轨油量=多项式(8.644e-12,5.465e-9,0.009588,0.03063,导轨长度)/2.4
fig = plt.figure()
...
ax1.grid(linestyle='--')
ax1.set_title('稀油润滑量消耗曲线',size=16)
