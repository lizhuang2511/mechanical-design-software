...
class MainForm4(QtWidgets.QWidget):
    signal_0 = pyqtSignal(str)
    def __init__(self,表名称='V带工况系数KA'):
        super(MainForm4, self).__init__()
    ...
    def 填充表格(self):
        ...
        self.tableWidget1.verticalHeader().setDefaultSectionSize(180)
        self.tableWidget1.horizontalHeader().setDefaultSectionSize(180)
        # 设置单元格居中显示
...
if __name__ == '__main__':
  ...
  Widget = MainForm4(表名称='普通V带的基准长度系列')
  Widget.show()
  sys.exit(app.exec_())