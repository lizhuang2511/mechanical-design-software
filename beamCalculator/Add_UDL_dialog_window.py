...
class Add_UDL_dialog_window(QtWidgets.QDialog):
    def __init__(self):
        ...
        uic.loadUi("../beamCalculator/UiFiles/Add_UDL_dialog_window.ui", self)
    ...
    def get_dialog_data(self):
        ...
        try:
            ...
            self.inputted_load_magnitude = float(magnitude) * self.inputted_load_direction/(float(end_location)-float(start_location))
            print(self.inputted_load_end_location)
